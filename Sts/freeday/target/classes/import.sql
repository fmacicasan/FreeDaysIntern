...
delete from `fduser`
INSERT INTO `fduser`(`id`,`version`,`granter`,`regular_user`,`hire_date`,`init_days`,`max_free_days`)VALUES(1,0,null,1,"2011-07-20 01:21:09",4,26);

delete from `app_reg_user_adv_role`
INSERT INTO `app_reg_user_adv_role`(`user_id`,`role_id`)VALUES(1,1);
