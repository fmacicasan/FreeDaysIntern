...
INSERT INTO `regular_user`(`id`,`activ`,`creationdate`,`deleted`,`email`,`firstname`,`lastmodified`,`password`,`surename`,`usermodifier`,`username`,`version`)VALUES(113,1,"2011-05-20 01:21:09",0,"harry_potter662266222000@yahoo.com","hector","2011-07-20 01:21:09","asdasd","furgea",NULL,"all",0)
...
delete from `fduser`
INSERT INTO `fduser`(`id`,`version`,`granter`,`regular_user`,`hire_date`,`init_days`,`max_free_days`)VALUES(111,0,113,111,"2011-07-20 01:21:09",4,26);
