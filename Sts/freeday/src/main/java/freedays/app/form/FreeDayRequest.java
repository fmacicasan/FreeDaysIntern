...
public class FreeDayRequest {
	 ...
	 * <li>TypeC -> Compensation free day received on request or for a previous
	 * TypeR day</li>
	...
	/**
	 * Factory used for the creation of FreeDayRequest form wrappers. This
	 * creation is dependent on the type of the request.
	 * 
	 * @param rt
	...
	// public static <T extends FreeDay> List<T> getMatchings(String username,
	// RequestType rt){
	...
	// default:
	// //throw new
	// IllegalArgumentException("The RequestType argument is invalid: should be R or C");
	// return null;
	// }
	//
	// }
