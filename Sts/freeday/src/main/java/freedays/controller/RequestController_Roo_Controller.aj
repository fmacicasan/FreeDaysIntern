...
privileged aspect RequestController_Roo_Controller {
    ...
    public String RequestController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("request", Request.findRequest(id));
        return "requests/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE)
    public String RequestController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        Request.findRequest(id).remove();
        uiModel.asMap().clear();
